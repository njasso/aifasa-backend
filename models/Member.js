...
    photo_url,
    public_id,
    cv_url, // Ajout de l'URL du CV
    cv_public_id, // Ajout de l'ID public du CV
    is_new_member = true,
...
        cv_url = COALESCE($14, cv_url), // Mise à jour de l'URL du CV
        cv_public_id = COALESCE($15, cv_public_id), // Mise à jour de l'ID public du CV
